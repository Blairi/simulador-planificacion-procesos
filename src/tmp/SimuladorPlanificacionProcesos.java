    ...
    public static void main(String[] args) {
        ...
        */
        ...
        while (!colaPL.estaVacia()) {
            ...
            // Actualizar el tiempo de llegada del proceso
            //****procesoActual.setTiempoLlegada(tiempoActual);
            ...
            if (procesoActual.getTiempoServicio() > 0) {
                ...
                int tiempoEspera = tiempoRespuesta -  procesoActual.tiempoLlegada - tiempoFinalizacion;
